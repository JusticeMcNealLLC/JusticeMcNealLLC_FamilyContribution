...
const CACHE_NAME = 'jm-portal-v207';
...
const SHELL_ASSETS = [
    ...
    '/css/shared.css?v=183',
    '/css/pages/portal/index.css?v=120',
    ...
    '/css/pages/portal/events/index.css?v=242',
    '/js/portal/events/events.bundle.js?v=250',
    '/manifest.json',
];
