...
assert(/manage\/sheet\.js\?v=110/.test(adminEventsHtml), 'admin events should request a versioned manage sheet to bypass stale SW caches');
assert(/manage\/sheet\.js\?v=110/.test(portalEventsHtml), 'portal events should request a versioned manage sheet to bypass stale SW caches');
