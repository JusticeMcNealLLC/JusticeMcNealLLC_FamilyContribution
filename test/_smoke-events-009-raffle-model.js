...
assert(/function evtDetailRaffleWinnersHtml\(/.test(detail), 'detail page should render grouped raffle winners');
assert(/ed-raffle-category/.test(detailCss), 'detail CSS should style raffle category groups');
assert(/ed-raffle-item-media/.test(detailCss), 'detail CSS should provide stable prize media slots');
assert(/function pubRafflePrizesHtml\(/.test(publicRaffle), 'public event page should render v2 raffle prize categories');
assert(/function pubRaffleWinnersHtml\(/.test(publicRaffle), 'public event page should render grouped raffle winners');
