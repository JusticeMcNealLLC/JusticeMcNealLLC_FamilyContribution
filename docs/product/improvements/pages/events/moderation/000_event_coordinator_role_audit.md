...
| Doc | Purpose |
| --- | --- |
| `docs/product/improvements/pages/events/list.md` | Improvement backlog entry 001 |
| `docs/product/audits/pages/events/019_major_events_improvements_planning.md` | Refactor checkpoint; classifies permission work as schema/RLS-gated |
| `docs/product/audits/pages/events/018_phase_4i_live_verifier_status.md` | Live classic-runtime verifier (do not recreate) |
