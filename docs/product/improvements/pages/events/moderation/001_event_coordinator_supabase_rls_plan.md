...
- `docs/product/improvements/pages/events/moderation/000_event_coordinator_role_audit.md` — original cross-stack audit
- `docs/product/improvements/pages/events/list.md` — improvement 001 backlog entry
