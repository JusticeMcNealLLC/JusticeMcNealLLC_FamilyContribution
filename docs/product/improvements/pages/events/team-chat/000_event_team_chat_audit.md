...
| Doc | Purpose |
| --- | --- |
| `docs/product/improvements/pages/events/list.md` | Improvement backlog **002** |
| `docs/product/improvements/pages/events/moderation/000_event_coordinator_role_audit.md` | Event Coordinator RBAC (global `events.manage_all`) |
| `docs/product/todo.md` | Product notes on team chat, volunteers, tasks |
...
**Verdict:** **Recommended v1** — matches product preference in `docs/product/todo.md` and this audit.
