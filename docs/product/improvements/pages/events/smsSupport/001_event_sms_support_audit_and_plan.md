...
| `docs/product/improvements/pages/events/moderation/000_event_coordinator_role_audit.md` | Coordinator RBAC |
| `docs/product/todo.md` | SMS vs push product intent |
| `docs/product/ROADMAP.md` | Phase 4D notifications backlog |
...
- `docs/product/todo.md` — explicit SMS vs push separation for events.
- `docs/product/ROADMAP.md` — Phase 4D Twilio backlog.
