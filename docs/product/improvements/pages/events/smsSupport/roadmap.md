...
| `docs/product/improvements/pages/events/list.md` | Events improvement backlog (add **003** when ready) |
| `docs/product/improvements/pages/events/moderation/000_event_coordinator_role_audit.md` | Event Coordinator RBAC |
| `docs/product/todo.md` | Product notes on SMS vs push (lines 14–15) |
