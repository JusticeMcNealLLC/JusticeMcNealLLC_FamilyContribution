...
**Path:** `docs/product/audits/pages/events/050_list_manage_create_risk_smoke_map.md`  
**Date:** 2026-05-21  
...
```bash
git status --short
git diff -- docs/product/audits/pages/events/050_list_manage_create_risk_smoke_map.md
git add docs/product/audits/pages/events/050_list_manage_create_risk_smoke_map.md
