...
**Path:** `docs/product/audits/pages/events/046_list_manage_create_audit_kickoff.md`  
**Date:** 2026-05-21  
...
```bash
git status --short
git diff -- docs/product/audits/pages/events/046_list_manage_create_audit_kickoff.md
git add docs/product/audits/pages/events/046_list_manage_create_audit_kickoff.md
