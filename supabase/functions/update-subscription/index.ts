...
// Updates an existing subscription to a new amount (effective next billing cycle)
...
serve(async (req) => {
  ...
  try {
    ...
    const newPriceId = await getOrCreatePrice(amountCents)

    // Update the subscription
    // proration_behavior: 'none' means change takes effect next billing cycle
    ...
    return new Response(
      JSON.stringify({ 
        success: true,
        message: 'Subscription updated. New amount will take effect on your next billing date.',
