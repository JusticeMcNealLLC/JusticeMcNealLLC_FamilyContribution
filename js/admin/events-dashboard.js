        ...
        return `
            <article class="bg-white rounded-2xl border border-gray-200/80 p-4 flex flex-col gap-3 hover:border-brand-200 hover:shadow-sm transition" data-event-id="${e.id}">
                ...
                <div class="flex items-center gap-2 pt-1">
                    ...
                    <a href="/pages/portal/events.html?event=${encodeURIComponent(e.slug || '')}" class="px-3 py-2 rounded-xl text-xs font-semibold text-gray-600 bg-gray-100 hover:bg-gray-200 transition" title="Open in portal">↗</a>
                </div>
            </article>`;
    }).join('');
}
