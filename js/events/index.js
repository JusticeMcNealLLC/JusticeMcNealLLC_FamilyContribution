...
/** Guest RSVP flow: compact member sign-in line (no email/account lookup). */
function pubMemberRsvpPromptHtml(eventSlug) {
    const href = pubPortalLoginHref(eventSlug);
    return `<p class="public-member-rsvp-inline" role="note" aria-label="Member sign-in">
        <span>Already a member?</span>
        <a href="${href}" data-public-signin class="public-member-rsvp-link">Sign in to RSVP</a>
    </p>`;
}
