 ...
 * Injects the middle 43 modules in the same order as the former 29-tag HTML block (+ list modules, create/geocode.js, legacy create modules, create step modules, raffle-builder, submit).
 */
(function () {
