 ...
 * Injects the middle 38 modules in the same order as the former 29-tag HTML block (+ create/geocode.js, legacy create modules, create step modules, raffle-builder, submit).
 */
(function () {
