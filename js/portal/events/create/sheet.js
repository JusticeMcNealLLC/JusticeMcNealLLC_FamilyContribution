...
(function () {
    ...
    // ─── Raffle builder (stays in orchestrator until 5M.1.3) ────────
    ...
    function _bindCreateStepsApi() {
        ...
        window.EventsCreateSteps.raffleBuilderHtml = _raffleBuilderHtml;
        window.EventsCreateSteps.raffleReviewHtml = _raffleReviewHtml;
        window.EventsCreateSteps.ensureRaffleConfig = _ensureRaffleConfig;
        window.EventsCreateSteps.wireRaffleBuilder = _wireRaffleBuilder;
    }
