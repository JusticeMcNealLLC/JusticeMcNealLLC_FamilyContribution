// Milestone tier data + helpers (ES module — single source of truth)
...
export function getCurrentTierIndex(totalCents) {
    let idx = -1;
...
export function getNextTier(totalCents) {
...
export function getProgressToNext(totalCents) {
