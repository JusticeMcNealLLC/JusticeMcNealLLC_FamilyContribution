...
async function addAdminDashboardLink() {
    ...
    if (logoutBtn) {
        ...
        // Sidebar: show the admin view link section
        const sideNavAdminSection = document.getElementById('sideNavAdminSection');
        if (sideNavAdminSection) sideNavAdminSection.classList.remove('hidden');
    }
